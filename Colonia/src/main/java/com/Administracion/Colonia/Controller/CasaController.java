...
import com.Administracion.Colonia.Service.CasaServiceImplements;
...
public class CasaController {
    private final CasaServiceImplements casaService;

    public CasaController(CasaServiceImplements casaService) {
